...
async function loadModel(model) {
  ...
  const config = MODEL_CONFIG[model];
  const loadingPromise = (0, import_transformers.pipeline)("feature-extraction", config.hfPath, {
...
var import_transformers, modelCache, loadingPromises;
...
__export(index_exports, {
  ...
  findKMostSimilar: () => findKMostSimilar,
